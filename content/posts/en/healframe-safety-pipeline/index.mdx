...
excerpt: "It started with a library book and became an AI pipeline that can't miss a crisis signal. My hardest question building HealFrame isn't technical — it's about legitimacy."
publishedAt: "2026-06-10"
author: "이시형"
category: development
tags: ["healframe", "mental-health", "ai-safety", "gemini"]
coverImage: "/images/posts/healframe-safety-pipeline.webp"
coverImageAlt: "Abstract shapes on a dark field: symmetrical planes narrowing toward a dark gap at the centre, with two green vertical bars set on either side of it."
faqs:
