...
excerpt: "Adding a CMS to this blog, the real question was which kind. I chose Keystatic on one rule — the source of truth never leaves my repo — plus its limits."
publishedAt: "2026-02-23"
updatedAt: "2026-06-10"
author: "이시형"
category: development
tags: ["keystatic", "cms", "nextjs"]
coverImage: "/images/posts/introducing-keystatic-cms.webp"
coverImageAlt: "Abstract shapes on a dark field: a thin-lined grid where two green-filled cells sit on opposite sides of a row line instead of lining up, with a third green cell apart from them on the right."
faqs: []
---
...
**Notion or a headless CMS (Contentful, Sanity, etc.)**: the content's source of truth moves into someone else's database. This blog doubles as my portfolio, and I didn't want the canonical copy of my writing living outside my repository. If the service shuts down or changes its pricing, the posts become hostages.
...
What the CMS solved was *formatting mistakes*, not *operational rules* — something I only saw clearly after adopting it.
...
Honestly, a CMS doesn't write the posts for me. It just removed one excuse not to write — and for me, even that much made it worth adopting.
