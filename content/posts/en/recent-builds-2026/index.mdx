...
**Argus Fusion** is a web app styled as an intelligence watch floor — it pulls 10+ live public feeds (earthquakes, aircraft, satellites, cyber vulnerabilities) and visualizes them on a Three.js globe. **Hoverslam** is a real-time multiplayer game inspired by SpaceX's Mechazilla booster catch, with suicide-burn physics — the last-second retro-propulsive landing burn — that I calibrated against public SpaceX data. Both began with "that would be fun to build."
